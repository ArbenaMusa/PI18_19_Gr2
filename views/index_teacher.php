<!DOCTYPE html>
    <head>
        ...
        <link href="aaa.css" rel="stylesheet" type="text/css" media="all" />
    </head>
    <body>
        <div id="header-wrapper">
            <div id="header" class="container">
                <div id="logo">
                    <h1><a href="aaa.html"></a>StuDB</a></h1>
                    <img src="StuDB.png" width="55" height="55">
                </div>
                <div id="menu">
                    <ul>
                        ...
                        <li>
                            <div class="dropdown">
                                <img src="StuDB.png" alt="Avatar" width="50" height="50" style="border: #FF4B2B solid 2px;">
                                <div class="dropdown-content">
                                    <img src="aaa.jpg" alt="Avatar" width="200" height="200" style="border: #FF4B2B solid 2px;">
                                    <div class="personal">Emer Mbiemer</div>
                                    <a href="#">Settings</a>
                                    <a href="#">Settings</a>
                                    <a href="#">Settings</a>
